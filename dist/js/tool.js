...
Component.options.__file = "resources/js/components/Wizard.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d724616", Component.options)
  } else {
    hotAPI.reload("data-v-2d724616", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__HandlesUploads__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_2__HandlesUploads__["a" /* default */]],
  props: _extends({
    navigation: {
      type: Boolean,
      default: false
    ...
    validationErrors: {
      type: Object,
      required: true,
      default: new __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["Errors"]()
    }

  }, Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["mapProps"])(['resourceName', 'resourceId', 'viaResource', 'viaResourceId', 'viaRelationship', 'shownViaNewRelationModal'])),
      ...
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return Nova.request().post('/nova-api/' + this.resourceName + '/step/' + this.current + '/clear');
  ...
  methods: {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 3;
                return this.nextHandler(this.checkpointResourceFormData);
    ...
    handleSubmitAndClose: function () {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 4;
                return this.submitHandler(this.checkpointResourceFormData, true);
      ...
      return handleSubmitAndClose;
    }(),
    handleSubmitAndStay: function () {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 4;
                return this.submitHandler(this.checkpointResourceFormData, false);
      ...
      function handleSubmitAndStay() {
        return _ref5.apply(this, arguments);
      }

      return handleSubmitAndStay;
    }()
  },
  ...
  computed: {
     ...
     */
    checkpointResourceFormData: function checkpointResourceFormData() {
      var _this = this;

      return _.tap(new FormData(), function (formData) {
        _.each(_this.currentPanel.fields, function (field) {
          field.fill(formData);
        });
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm.navigation && _vm.steps.length > 1
        ? _c("wizard-nav", {
            class: "mb-6",
            attrs: { steps: _vm.steps, current: _vm.current }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.panels
        ? _c(
            "form",
            {
              ...
              on: { submit: _vm.handleSubmitAndClose }
            },
            [
              _vm.currentPanel
                ? _c("form-panel", {
                    key: _vm.currentPanel.name,
                    staticClass: "mb-8",
                    attrs: {
                      "shown-via-new-relation-modal":
                        _vm.shownViaNewRelationModal,
                      panel: _vm.currentPanel,
                      name: _vm.currentPanel.name,
                      "resource-name": _vm.resourceName,
                      "resource-id": _vm.resourceId,
                      fields: _vm.currentPanel.fields,
                      mode: "form",
                  ...
                  _vm.current
                    ? _c(
                        "progress-button",
                        {
                          ...
                          nativeOn: {
                            click: function($event) {
                              return _vm.handlePreviousStep($event)
                            }
                          }
                        },
                        [
                    ...
                    ? _c(
                        "progress-button",
                        {
                          ...
                          attrs: {
                            ...
                            disabled: _vm.isWorking,
                            processing: _vm.wasSubmitedViaClose
                          },
                          nativeOn: {
                            click: function($event) {
                              return _vm.handleSubmitAndStay($event)
                            }
                          }
                        },
                        [
                    ...
                    ? _c(
                        "progress-button",
                        {
                          ...
                          attrs: {
                            dusk: "submit-step",
                            disabled: _vm.isWorking,
                            processing: _vm.submitd
                          },
                          nativeOn: {
                            click: function($event) {
                              return _vm.handleSubmitAndClose($event)
                            }
                          }
                        },
                        [_vm._v("\n        " + _vm._s(_vm.submit) + "\n      ")]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2d724616", module.exports)
  }
}
...
Component.options.__file = "resources/js/components/Navigator.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27e6d0fc", Component.options)
  } else {
    hotAPI.reload("data-v-27e6d0fc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    isActive: function isActive(step, index) {
      return this.current === index;
    },
    isLastStep: function isLastStep(step) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("card", { staticClass: "flex justify-center shadow-md p-2" }, [
    _c(
      "div",
      {
        staticClass: "flex justify-arround w-full",
        class: {
          "max-w-lg": _vm.steps.length < 3,
          "max-w-xl": _vm.steps.length >= 3 && _vm.steps.length < 5
        }
      },
      _vm._l(_vm.steps, function(step, index) {
        return _c("wizard-step", {
          ...
          attrs: {
            ...
            last: _vm.steps.length - 1 === index
          },
          on: { clicked: _vm.handleClick }
        })
      }),
      1
    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-27e6d0fc", module.exports)
  }
}
...
var update = __webpack_require__(19)("3256f7ff", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0e759092\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Step.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0e759092\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Step.vue");
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass: "flex items-center",
      class: { "w-full": !_vm.last, "w-24": _vm.last }
    },
    [
      _c(
        "div",
        {
          staticClass:
            "flex items-center w-24 h-step rounded-full flex items-center justify-center shadow-inner bg-40 text-80 -mr-px -ml-px btn btn-link cursor-pointer",
          class: {
            "border border-success bg-white text-success": _vm.step.passed,
            "border border-info bg-white text-info": _vm.active
          },
          on: {
            click: function($event) {
              return _vm.$emit("clicked", _vm.step)
            }
          }
        },
        [
          _c("span", { staticClass: "min-w-24 px-2 text-center" }, [
            _vm._v(_vm._s(_vm.step.name))
          ])
        ]
      ),
      _vm._v(" "),
      !_vm.last
        ? _c("div", {
            staticClass: "w-full py-1 shadow-inner bg-40 text-80",
            class: {
              "border-t border-b border-success bg-white text-success":
                _vm.step.passed,
              "border-t border-b border-info bg-white text-info": _vm.active
            }
          })
        : _vm._e()
    ]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_laravel_nova___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__HandlesSteps__ = __webpack_require__(3);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["InteractsWithResourceInformation"], __WEBPACK_IMPORTED_MODULE_2__HandlesSteps__["a" /* default */]],
  ...
  }, Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["mapProps"])(['resourceName', 'resourceId', 'viaResource', 'viaResourceId', 'viaRelationship'])),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _context.next = 6;
              return Nova.request().get('/nova-api/' + this.viaResource + '/field/' + this.viaRelationship, {
                params: {
                  resourceName: this.resourceName,
                  viaResource: this.viaResource,
                  viaResourceId: this.viaResourceId,
  ...
  methods: {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 4;
                return Nova.request().get('/nova-api/' + this.resourceName + '/step/' + this.step + '/creation-fields', {
                  params: {
                    editing: true,
                    editMode: 'create',
    ...
    handleNext: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(formData) {
        var _ref6, _ref6$data, redirect, id;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return this.checkpointRequest(formData, this.currentPanel.checkpoint !== true);
              ...
              case 3:
                ...
                if (this.currentPanel.checkpoint !== true) Nova.success(this.__('The session was saved!'));else Nova.success(this.__('The :resource was created!', {
    ...
    handleSubmit: function () {
      var _ref7 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4(formData, close) {
        var _ref8, _ref8$data, redirect, id;
     ...
     */
    checkpointRequest: function checkpointRequest(formData) {
      var session = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      return Nova.request().post('/nova-api/' + this.resourceName + '/step/' + this.step, formData, {
        params: {
          editing: true,
          editMode: 'create',
     ...
     * Send a checkpoint request for this resource
     */
    createRequest: function createRequest(formData) {
      return Nova.request().post('/nova-api/' + this.resourceName + '/step/' + this.step, formData, {
        params: {
          editing: true,
          editMode: 'create',
  ...
  computed: {
    ...
    alreadyFilled: function alreadyFilled() {
      return this.relationResponse && this.relationResponse.alreadyFilled;
    },
    isHasOneRelationship: function isHasOneRelationship() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("wizard-form", {
        attrs: {
          navigation: _vm.$route.navigable,
          "resource-name": _vm.resourceName,
          "resource-id": _vm.resourceId,
          "via-resource": _vm.viaResource,
          "via-resource-id": _vm.viaResourceId,
          "via-relationship": _vm.viaRelationship,
          panels: _vm.panelsWithFields,
          "next-handler": _vm.handleNext,
          "previous-handler": _vm.handlePrevious,
          "submit-handler": _vm.handleSubmit,
          submit: _vm.__("Create :resource", { resource: _vm.singularName }),
          "submit-and-stay": _vm.__("Create & Add Another"),
          "validation-errors": _vm.validationErrors
        },
        on: { cancelled: _vm.handleCancelled }
      })
    ],
    1
  )
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: Object(__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["mapProps"])(['resourceName', 'resourceId', 'viaResource', 'viaResourceId', 'viaRelationship']),
  ...
  methods: {
    ...
    handleSubmit: function () {
      var _ref5 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee3(formData, close) {
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
     ...
     */
    handleNext: function () {
      var _ref6 = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee4(formData) {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.prev = 0;
                _context4.next = 3;
                return this.updateRequest(formData);

              case 3:
                _ref7 = _context4.sent;
                redirect = _ref7.data.redirect;
    ...
    updateRequest: function updateRequest(formData) {
      ...
      return Nova.request().post('/nova-api/' + this.resourceName + '/' + this.resourceId, _.tap(formData, function (formData) {
    ...
    [
      ...
      _c("wizard-form", {
        attrs: {
          ...
          "previous-handler": _vm.handlePrevious,
          "submit-handler": _vm.handleSubmit,
          submit: _vm.__("Update :resource", { resource: _vm.singularName }),
          "submit-and-stay": _vm.__("Update & Continue Editing"),
          "validation-errors": _vm.validationErrors
        },
        on: {
